document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('shipment-form').addEventListener('submit', function(event) {
        ...
        if (formData.container_number.toString().length !== 8) {
            responseMessage.textContent = "Container number must be exactly 8 digits.";
            responseMessage.classList.remove("green"); 
            responseMessage.classList.add("red"); 
            responseMessage.style.display = "block"; 
            return; 
        ...
        if (formData.po_number.toString().length !== 8) {
            responseMessage.textContent = "PO number must be exactly 8 digits.";
            responseMessage.classList.remove("green"); 
            responseMessage.classList.add("red"); 
            responseMessage.style.display = "block"; 
            return; 
        ...
        if (formData.batch_id.toString().length !== 8) {
            responseMessage.textContent = "Batch ID must be exactly 8 digits.";
            responseMessage.classList.remove("green"); 
            responseMessage.classList.add("red"); 
            responseMessage.style.display = "block"; 
            return; 
